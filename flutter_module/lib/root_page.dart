import 'package:fluttermodule/default_page.dart';
import 'package:fluttermodule/detail_page.dart';
import 'package:fluttermodule/home_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

// Channel
const CHANNEL = "com.lankv.demointegrateflutter";
...
class _RootPageState extends State<RootPage> {
  ...
  Future<void> _triggerFromNative(MethodCall call) async {
    if (call.method == "notifyNavToFlutter") {
      print("Lankv _triggerFromNative notifyNavToFlutter");
